...
const Header = () => {
  ...
  return (
    <nav>
      ...
      <div className="fixed bottom-0 z-30 flex h-11 w-full justify-end bg-neutral md:hidden">
        <button
          aria-label="open"
      ...
      <div
        ...
        className={
          isOpen
            ? "absolute left-0 flex h-full w-full transform flex-col items-start justify-start bg-nav transition duration-150 ease-in-out sm:w-[250px] sm:max-w-[250px] md:sticky md:translate-x-0"
            : "hidden"
        }
      >
        {/* Site Logo and Name  */}
